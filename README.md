...
{Element}                                             https://packages.riot.im/desktop/install/win32/x64/Element%20Set…
{ExplorerSuite, Explorer Suite}                       https://ntcore.com/files/ExplorerSuite.exe
{fd}                                                  https://github.com/sharkdp/fd
{Firefox}                                             https://download.mozilla.org/?product=firefox-msi-latest-ssl&os=…
...
{p4merge}                                             https://www.perforce.com/downloads/perforce/r22.1/bin.ntx64/p4vi…
...
{Rust}                                                https://static.rust-lang.org/rustup/dist/x86_64-pc-windows-msvc/…
...
{vscode, Visual Studio Code, code}                    https://code.visualstudio.com/sha/download?build=stable&os=win32…
        ...
        @{
            ...
            "Install" = {
                Expand-ArchiveFile -PassThru $Installer $ENV:PROGRAMFILES\SysinternalsSuite `
                    ...
                    | ForEach-Object { New-AppPathsItem $_ }
                }
        },
        @{
